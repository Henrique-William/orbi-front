"use client"; // Necessário porque ProtectedRoute usa hooks

import Link from "next/link";
import ProtectedRoute from "@/app/component/ProtectedRoute"; // Ajuste o caminho se necessário
              ...
              <div className="w-full">
                ...
                <div className="mb-3">
                  <input
                      ...
                      className="w-full rounded-lg border border-[#ccc] p-3 text-sm outline-none focus:border-[#450693] text-black"
                  />
                </div>
